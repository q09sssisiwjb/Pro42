...
const ChatButton = () => {
  ...
  const menuItems = [
    ...
    { icon: Zap, label: 'Upscale', action: () => console.log('Upscale') },
    { icon: Eraser, label: 'Remove BG', action: () => console.log('Remove BG') },
    { icon: RefreshCw, label: 'Image to Image', action: () => console.log('Image to Image') },
    { icon: PenTool, label: 'Sketch', action: () => console.log('Sketch') },
  ];
